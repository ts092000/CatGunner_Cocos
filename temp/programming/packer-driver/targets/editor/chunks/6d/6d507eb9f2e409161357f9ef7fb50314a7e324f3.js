      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        update(dt) {
          this.GameModel.BossContainer.children.map(boss => {
            ...
            let bossNodeController = boss.getComponent(_crd && BossController === void 0 ? (_reportPossibleCrUseOfBossController({
              error: Error()
            }), BossController) : BossController);
            let playerNodeController = this.GameModel.PlayerNode.getComponent(_crd && PlayerController === void 0 ? (_reportPossibleCrUseOfPlayerController({
              error: Error()
            }), PlayerController) : PlayerController);
          ...
          this.GameModel.EnemyContainerNode.children.map(enemy => {
            let enemyNeareast = new Node();
            enemyNeareast = this.findNearestEnemy();
            let enemyPos = enemy.getPosition();
            let enemyNodeController = enemy.getComponent(_crd && EnemyController === void 0 ? (_reportPossibleCrUseOfEnemyController({
              error: Error()
        ...
        getEnemyFromPool() {
          ...
          let elementNode = element.getComponent(_crd && EnemyController === void 0 ? (_reportPossibleCrUseOfEnemyController({
            error: Error()
          }), EnemyController) : EnemyController);
        ...
        putEnemyIntoPool(enemy) {
          let enemyControllerComponent = enemy.getComponent(_crd && EnemyController === void 0 ? (_reportPossibleCrUseOfEnemyController({
            error: Error()
          }), EnemyController) : EnemyController);
        ...
        instantiateHostage(node) {
          ...
          let hostageComponent = node.getComponent(_crd && HostageController === void 0 ? (_reportPossibleCrUseOfHostageController({
            error: Error()
        ...
        checkHostage() {
          this.GameModel.HostageContainer.children.map(hostage => {
            ...
            let hostageNodeController = hostage.getComponent(_crd && HostageController === void 0 ? (_reportPossibleCrUseOfHostageController({
              error: Error()
            }), HostageController) : HostageController);
        ...
        instantiateObstacle(node) {
          ...
          for (let i = 0; i < randomRangeInt(2, 5); i++) {
            ...
            let obstacleComponent = node.getComponent(_crd && ObstacleController === void 0 ? (_reportPossibleCrUseOfObstacleController({
              error: Error()
        ...
        spawnEnemy(node, type, canShoot) {
          let nodeEnemy = node.getComponent(_crd && EnemyController === void 0 ? (_reportPossibleCrUseOfEnemyController({
            error: Error()
          }), EnemyController) : EnemyController);
        ...
        instantiateSpike(node) {
          ...
          let randomNumb = randomRangeInt(2, 5); // let initPosX = 50;
          ...
          for (let i = 0; i < randomNumb; i++) {
            ...
            for (let j = 0; j < 2; j++) {
              ...
              let spikeNode = node.children[0].getComponent(_crd && SpikeController === void 0 ? (_reportPossibleCrUseOfSpikeController({
                error: Error()
              }), SpikeController) : SpikeController);
              node.parent = this.GameModel.SpikeContainer; // this.GameModel.SpikeContainer.insertChild(node, 0)
        ...
        instantiateBullet(node) {
          ...
          let nodeBullet = node.getComponent(_crd && BulletController === void 0 ? (_reportPossibleCrUseOfBulletController({
            error: Error()
        ...
        instantiateBossBullet(node, bulletPosX, bulletPosY) {
          ...
          let nodeBullet = node.getComponent(_crd && BulletBossController === void 0 ? (_reportPossibleCrUseOfBulletBossController({
            error: Error()
        ...
        instantiateEnemyBullet(newNode, enemyPosX, enemyPosY, enemyNode) {
          ...
          let nodeBullet = newNode.getComponent(_crd && BulletEnemyController === void 0 ? (_reportPossibleCrUseOfBulletEnemyController({
            error: Error()
        ...
        getEnemyAnimDeadFromPool() {
          let element = this.PoolObject.PoolEnemyDead.size() > 0 ? this.PoolObject.PoolEnemyDead.get() : instantiate(this.GameModel.EnemyDeadAnimPrefab); // element.scale = new Vec3(1, 1);
        ...
        instantiateDropBullet(dropBullet, velocityX) {
          ...
          let tweenOpacityDropBullet = tween(dropBulletOpacity).to(1, {
            opacity: 0
          });
          ...
          switch (event.keyCode) {
            ...
            case KeyCode.KEY_F:
              if (this.isPressDash) {
                ...
                let tweenBtnDash = tween(this.GameView.DashBtnProgressBar).to(5, {
                  progress: 1
                });
            ...
            case KeyCode.KEY_Z:
              if (this.isPressPowerUp && this.countPlusDame != 0) {
                ...
                let tweenBtnPowerUp = tween(this.GameView.PowerUpProgressBar).to(30, {
                  progress: 1
                });
                this.isPressPowerUp = false;
                tweenBtnPowerUp.start();
                let tweenLabelPowerUp = tween(this.GameView.BuffPowerUpLabelNode).to(1, {
            ...
            case KeyCode.KEY_X:
              if (this.isPressHeal && this.playerControllerComponent.currentPLayerHp < this.GameView.HpMax && this.countHeal != 0) {
                ...
                let tweenBtnHeal = tween(this.GameView.HealProgressBar).to(30, {
                  progress: 1
                });
        ...
        onBeginContactCage(selfCollider, otherCollider, contact) {
          this.scheduleOnce(function () {
            if (selfCollider.tag === 10) {
              let hostageComponent = selfCollider.node.parent.getComponent(_crd && HostageController === void 0 ? (_reportPossibleCrUseOfHostageController({
                error: Error()
              }), HostageController) : HostageController);
              ...
              let animBulletExplode = new Node();
        ...
        onBeginContactObstacle(selfCollider, otherCollider, contact) {
          this.scheduleOnce(function () {
            if (selfCollider.tag === 10 && otherCollider.tag != 1) {
              let obstacleComponent = selfCollider.node.getComponent(_crd && ObstacleController === void 0 ? (_reportPossibleCrUseOfObstacleController({
                error: Error()
              }), ObstacleController) : ObstacleController);
              let type = this.playerDameInit;
        ...
        tweenArrowDirecion() {
          ...
          let tweenArrowDirecion = tween(this.GameModel.ArrowDirection).to(tweenDuration, {
          ...
          let tweenArrowDirecionOpacity = tween(this.GameModel.ArrowDirectionOpacity).to(tweenDuration, {
            opacity: 150
          }).to(tweenDuration, {
            opacity: 255
          }).start();
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          this.scheduleOnce(function () {
            if (otherCollider.tag === 0) {
              let enemyControllerNode = selfCollider.node.getComponent(_crd && EnemyController === void 0 ? (_reportPossibleCrUseOfEnemyController({
                error: Error()
              }), EnemyController) : EnemyController);
              ...
              if (enemyControllerNode.hp <= 0) {
                ...
                this.scheduleOnce(function () {
                  let tweenAnimDead = tween(animDeadNode.getComponent(UIOpacity)).to(1, {
                    opacity: 0
                  });
                  tweenAnimDead.start();
                }, 2.68);
        ...
        onBeginContactBoss(selfCollider, otherCollider, contact) {
          this.scheduleOnce(function () {
            if (otherCollider.tag === 0) {
              let enemyControllerNode = selfCollider.node.getComponent(_crd && BossController === void 0 ? (_reportPossibleCrUseOfBossController({
                error: Error()
              }), BossController) : BossController);
              enemyControllerNode.hp -= this.playerControllerComponent.dame;
        ...
        onBeginContactPlayer(selfCollider, otherCollider, contact) {
          this.scheduleOnce(function () {
            if (otherCollider.tag === 0) {
              ...
              let tweenReward = tween(otherCollider.node).to(1, {
              ...
              this.rewardCount++;
              this.GameView.RewardCountLabel.string = this.rewardCount.toString();
              let tweenRewardOpacity = tween(otherCollider.node.getComponent(UIOpacity)).to(1, {
                opacity: 0
              });
              tweenReward.start();
            ...
            if (otherCollider.tag === 3) {
              ...
              let otherColliderNode = otherCollider.node.getComponent(_crd && BulletBossController === void 0 ? (_reportPossibleCrUseOfBulletBossController({
                error: Error()
              }), BulletBossController) : BulletBossController);
        ...
        warningLevelUpEnemy() {
          ...
          let tweenWarning = tween(this.GameView.EnemyLevelUpUIOpacity).to(0.5, {
            opacity: 0
          }).to(0.5, {
            opacity: 255
          });
          ...
          tweenWarning.start();
          this.scheduleOnce(function () {
            let tweenWarning2 = tween(this.GameView.EnemyLevelUpUIOpacity).to(0.5, {
              opacity: 0
            });
            tweenWarning2.start();
            this.scheduleOnce(function () {
        ...
        playAgain() {
          ...
          let tweenLoadingAnim = tween(this.GameView.LoadingAnimProgressBar).to(1.5, {
            progress: 1
          });
        ...
        playerTakeDame(hp, playerNodeController) {
          this.playSoundGame(2);
          let tweenOpacityPlayer = tween(this.GameModel.PlayerUIOpacity).to(0.25, {
            opacity: 100
          }).to(0.25, {
            opacity: 255
          });
          ...
          if (playerNodeController.currentPLayerHp <= this.GameView.HpMax / 4 && this.isWarningLowHealth) {
            ...
            let tweenWarning = tween(this.GameView.WarningLowHealthOpacity).to(0.5, {
              opacity: 0
            }).to(0.5, {
              opacity: 255
            });
        ...
        instantiateBoss() {
          ...
          let nodeEnemy = node.getComponent(_crd && BossController === void 0 ? (_reportPossibleCrUseOfBossController({
            error: Error()
          }), BossController) : BossController);
        ...
        checkBossAction(enemy, direction, dt) {
          let enemyControllerComponent = enemy.getComponent(_crd && BossController === void 0 ? (_reportPossibleCrUseOfBossController({
            error: Error()
          }), BossController) : BossController);
          let playerNodeController = this.GameModel.PlayerNode.getComponent(_crd && PlayerController === void 0 ? (_reportPossibleCrUseOfPlayerController({
            error: Error()
          ...
          if (enemy.position.x - this.GameModel.PlayerNode.position.x <= -150 && enemy.position.x - this.GameModel.PlayerNode.position.x >= -300 && !enemyControllerComponent.isAttack || enemy.position.x - this.GameModel.PlayerNode.position.x >= 150 && enemy.position.x - this.GameModel.PlayerNode.position.x <= 300 && !enemyControllerComponent.isAttack && !this.isOver && !enemyControllerComponent.isDead) {
            ...
            let tweenAttack = tween(enemy).to(0.2, {
            ...
            this.scheduleOnce(function () {
              if (!enemyControllerComponent.isDead) {
                ...
                let tweenCrackOpacity = tween(this.GameModel.CrackNodeOpacity).to(1, {
                  opacity: 0
                });
            ...
            let bossBullet = new Node();
            bossBullet = this.instantiateBossBullet(bossBullet, enemy.position.x, enemy.position.y);
            let bulletBossComponent = bossBullet.getComponent(_crd && BulletBossController === void 0 ? (_reportPossibleCrUseOfBulletBossController({
              error: Error()
            }), BulletBossController) : BulletBossController);
        ...
        async initGame() {
          ...
          await gameClientParams.gameClient.match.startMatch().then(data => {
            this.matchData = data; // this.startMatchLog();
          }).catch(error => console.log(error));
        }

        async completeGame() {
          await this.gameClient.match.completeMatch(this.matchData, {
            score: this.scoreCurrent
          }).then(async data => {
            if (this.scoreCurrent > (_crd && DataUser === void 0 ? (_reportPossibleCrUseOfDataUser({
              error: Error()
            }), DataUser) : DataUser).dataUser.data.highScore) {
              (_crd && DataUser === void 0 ? (_reportPossibleCrUseOfDataUser({
                error: Error()
              }), DataUser) : DataUser).dataUser.data.highScore = this.scoreCurrent;
            }

            this.GameView.HighScoreLabel.string = (_crd && DataUser === void 0 ? (_reportPossibleCrUseOfDataUser({
              error: Error()
            }), DataUser) : DataUser).dataUser.data.highScore.toString();
            (_crd && DataUser === void 0 ? (_reportPossibleCrUseOfDataUser({
              error: Error()
            }), DataUser) : DataUser).dataUser.data.rewardCount += this.rewardCount;
            (_crd && DataUser === void 0 ? (_reportPossibleCrUseOfDataUser({
              error: Error()
            }), DataUser) : DataUser).dataUser.data.scoreCount += this.scoreCurrent;
            await this.gameClient.user.data.setGameData({
              [this.userId]: (_crd && DataUser === void 0 ? (_reportPossibleCrUseOfDataUser({
                error: Error()
        ...
        changeColorSpriteFull(hexColor) {
          ...
          let tweenWarningColor = tween(this.GameView.ColorFullUIOpacity).to(0.5, {
            opacity: 50
          }).to(0.5, {
            opacity: 0
          });
        ...
        appearBoosterNode() {
          ...
          let tweenBoosterNode = tween(this.GameModel.BoosterNode).to(0.5, {
            position: new Vec3(0, 0)
          }, {
            easing: "linear"
          });
          tweenBoosterNode.start();
          let arr = this.shuffleArray([0, 1, 2, 3, 4]); // let result = arr.slice(0, 3);
        ...
        settingBooster(num, note, type, level, name, price) {
          let playerControllerComponent = this.GameModel.PlayerNode.getComponent(_crd && PlayerController === void 0 ? (_reportPossibleCrUseOfPlayerController({
            error: Error()
          }), PlayerController) : PlayerController);
        ...
        clickBoosterUnsuccessfully() {
          ...
          let tweenNoti = tween(this.GameModel.NotiLabel.node).to(0.5, {
        ...
        skipBoosterBtnAction() {
          ...
          let tweenFade = tween(this.GameModel.FadeUIOpacity).to(0.5, {
            opacity: 255
          }).to(0.5, {
            opacity: 0
          });
        ...
        spawningEnemyAction(node, nodeComponent) {
          ...
          let tweenScale = tween(node).to(0.5, {
            scale: new Vec3(1, 1)
          });
          tweenScale.start();
          this.scheduleOnce(function () {
...
//# sourceMappingURL=6d507eb9f2e409161357f9ef7fb50314a7e324f3.js.map